...
describe('[UNIT] WorkSet', () => {
  ...
  test('should split work and cover odd work domain', () => {
  ...
  test('should split work and cover even work domain', () => {
  ...
  test('should split work and cover empty work domain', () => {
    var domain = [];
  ...
  test('should split work and cover single work domain', () => {
    var domain = [5];
    var divisions = [1, 2, 3, 4, 1000];
