...
import type { TypeScriptReporterConfiguration } from 'lib/typescript/TypeScriptReporterConfiguration';
import type { TypeScriptReporterOptions } from 'lib/typescript/TypeScriptReporterOptions';
import type webpack from 'webpack';

describe('typescript/TypeScriptsReporterConfiguration', () => {
  ...
  it.each([
    ...
    const { createTypeScriptReporterConfiguration } = await import(
      'lib/typescript/TypeScriptReporterConfiguration'
    );
