...
import type { TypeScriptConfig } from 'lib/typescript/typescript-config';

describe('typescript/typescript-support', () => {
  ...
  it('throws error if typescript is not installed', async () => {
    ...
    const { assertTypeScriptSupport } = await import('lib/typescript/typescript-support');
