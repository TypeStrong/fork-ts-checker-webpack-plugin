...
// message factories
exports.createNormalizedMessageFromDiagnostic = NormalizedMessageFactories_1.makeCreateNormalizedMessageFromDiagnostic(
  typescript
);
...
const checker =
  process.env.USE_INCREMENTAL_API === 'true'
    ? new ApiIncrementalChecker_1.ApiIncrementalChecker(
        typescript,
        exports.createNormalizedMessageFromDiagnostic,
        exports.createNormalizedMessageFromRuleFailure,
    ...
    : new IncrementalChecker_1.IncrementalChecker(
        typescript,
        exports.createNormalizedMessageFromDiagnostic,
        exports.createNormalizedMessageFromRuleFailure,
        process.env.TSCONFIG,
...
process.on('message', message => {
  run(
    CancellationToken_1.CancellationToken.createFromJSON(typescript, message)
  );
});
process.on('SIGINT', () => {
  process.exit();
