...
import type { TypeScriptEmbeddedSource } from '../typescript-embedded-extension';
import { createTypeScriptEmbeddedExtension } from '../typescript-embedded-extension';
...
import type { TypeScriptVueExtensionConfig } from './typescript-vue-config';
